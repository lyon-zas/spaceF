...
class QuizPlayMath extends StatefulWidget {
  final String quizId;
  final String coll;
  final int number;
  final String title;
  ...
  const QuizPlayMath(this.quizId, this.coll, this.number,
      {Key? key,
      required this.usern,
      required this.title,
  ...
  @override
  _QuizPlayMathState createState() => _QuizPlayMathState();
}
...
class _QuizPlayMathState extends State<QuizPlayMath> {
...
class QuizPlayMathTile extends StatefulWidget {
  final QuestionModel questionModel;
  final int index;

  const QuizPlayMathTile(
      {Key? key, required this.questionModel, required this.index})
      : super(key: key);

  @override
  _QuizPlayMathTileState createState() => _QuizPlayMathTileState();
}

class _QuizPlayMathTileState extends State<QuizPlayMathTile> {
