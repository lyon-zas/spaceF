...
class Math2List extends StatefulWidget {
  const Math2List({Key? key}) : super(key: key);

  @override
  _Math2ListState createState() => _Math2ListState();
}

class _Math2ListState extends State<Math2List> {
  @override
  void initState() {
    super.initState();
      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          return QuizPlayMath(
            ...
            title: 'Math102 Quizes', storeName: 'Mth102',
          );
        }));
      },
      child: Container(
