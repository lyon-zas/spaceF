...
class QuizPlayBio extends StatefulWidget {
  final String quizId;
  final String coll;
  final int number;
  final String title;
  ...
  const QuizPlayBio(this.quizId, this.coll, this.number,
      {Key? key,
      required this.usern,
      required this.title,
  ...
  @override
  _QuizPlayBioState createState() => _QuizPlayBioState();
}
...
class _QuizPlayBioState extends State<QuizPlayBio> {
...
class QuizPlayBioTile extends StatefulWidget {
  final QuestionModel questionModel;
  final int index;

  const QuizPlayBioTile(
      {Key? key, required this.questionModel, required this.index})
      : super(key: key);

  @override
  _QuizPlayBioTileState createState() => _QuizPlayBioTileState();
}

class _QuizPlayBioTileState extends State<QuizPlayBioTile> {
