...
class QuizPlayChm extends StatefulWidget {
  final String quizId;
  final String coll;
  final int number;
  final String title;
  ...
  const QuizPlayChm(this.quizId, this.coll, this.number,
      {Key? key, required this.usern, required this.title, required this.storeName})
      : super(key: key);

  @override
  _QuizPlayChmState createState() => _QuizPlayChmState();
}
...
class _QuizPlayChmState extends State<QuizPlayChm> {
...
class QuizPlayChmTile extends StatefulWidget {
  final QuestionModel questionModel;
  final int index;

  const QuizPlayChmTile(
      {Key? key, required this.questionModel, required this.index})
      : super(key: key);

  @override
  _QuizPlayChmTileState createState() => _QuizPlayChmTileState();
}

class _QuizPlayChmTileState extends State<QuizPlayChmTile> {
