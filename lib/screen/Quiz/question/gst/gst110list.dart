...
class Gst110List extends StatefulWidget {
  const Gst110List({Key? key}) : super(key: key);

  @override
  _Gst110ListState createState() => _Gst110ListState();
}

class _Gst110ListState extends State<Gst110List> {
  @override
  void initState() {
    super.initState();
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          return QuizPlayGst(quizId, 'GST110', number, usern: provider.userName, title: 'GST110 Quizes',storeName: 'Gst110',);
        }));
      },
      child: Container(
