...
class Gst204List extends StatefulWidget {
  const Gst204List({Key? key}) : super(key: key);

  @override
  _Gst204ListState createState() => _Gst204ListState();
}

class _Gst204ListState extends State<Gst204List> {
  @override
  void initState() {
    super.initState();
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          return QuizPlayGst(quizId, 'GST204', number, usern: provider.userName, title: 'GST204 Quizes',storeName: 'Gst204',);
        }));
      },
      child: Container(
