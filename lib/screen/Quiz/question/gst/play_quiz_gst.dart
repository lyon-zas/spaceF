...
class QuizPlayGst extends StatefulWidget {
  final String quizId;
  final String coll;
  final int number;
  final String title;
  ...
  final usern;
  const QuizPlayGst(this.quizId, this.coll, this.number,
      {Key? key, required this.usern, required this.title, required this.storeName})
      : super(key: key);

  @override
  _QuizPlayGstState createState() => _QuizPlayGstState();
}
...
class _QuizPlayGstState extends State<QuizPlayGst> {
...
class QuizPlayGstTile extends StatefulWidget {
  final QuestionModel questionModel;
  final int index;

  const QuizPlayGstTile(
      {Key? key, required this.questionModel, required this.index})
      : super(key: key);

  @override
  _QuizPlayGstTileState createState() => _QuizPlayGstTileState();
}

class _QuizPlayGstTileState extends State<QuizPlayGstTile> {
