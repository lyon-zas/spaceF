...
class Cpe1List extends StatefulWidget {
  const Cpe1List({Key? key}) : super(key: key);

  @override
  _Cpe1ListState createState() => _Cpe1ListState();
}

class _Cpe1ListState extends State<Cpe1List> {
  @override
  void initState() {
    super.initState();
      ...
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          return QuizPlayCpe(
            ...
            title: 'Cpe101 Quizes', storeName: 'Cpe101',
